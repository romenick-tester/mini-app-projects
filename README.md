...
## 20. Dark Mode
![dark mode](https://i.ibb.co/5j27CT1/dark-mode.png)
* see this app in action: https://tester-dark-mode.netlify.app

> Pointers: <br>
    1. css variables set into class <br>
    2. localStorage.getItem("name") + localStorage.setItem("name") <br>

## 21. Movie DB
![movie db](https://i.ibb.co/6wfKMLj/moviedb.png)
